...
- **Authentication**: A dedicated signup system located at `/auth/signup` with support for social media registration (e.g., Facebook).
- **Modern UI**: Built with Tailwind CSS for a responsive and polished user experience.
